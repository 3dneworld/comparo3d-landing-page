...
export function BadgeChip({ badge }: { badge: QuoteOptionBadge }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5">
      <img src={meta.imgSrc} alt="" aria-hidden="true" className="h-6 w-6 object-contain" />
      <span
        className={`inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[12px] font-semibold ${toneClasses}`}
      >
