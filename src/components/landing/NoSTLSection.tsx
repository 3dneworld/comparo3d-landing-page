      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <AnimateOnScroll variant="fade-up">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h3 className="text-xl md:text-2xl font-bold font-heading text-foreground mb-3 flex items-center justify-center gap-2">
              <MessageCircle size={22} className="text-green-500" />
              ¿Tenés una idea o una foto?
            </h3>

            <p className="text-muted-foreground text-base md:text-lg leading-relaxed mb-8">
              A partir de una foto, boceto o plano simple generamos el STL
              listo para que cotices con nuestros proveedores.
            </p>
