  ...
  particular: [
    {
      ...
      strengths: ["+ económico", "+ definición", "rígido"],
    ...
    },
    {
      ...
      strengths: ["resistente", "uso práctico", "durabilidad"],
    ...
    },
    {
      ...
      strengths: ["resistente", "durable", "flexible"],
    ...
    },
    {
      ...
      strengths: ["+ resistente", "soporta 111°C", "+ robusto"],
